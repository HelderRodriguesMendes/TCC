 ...
 * @author Carmen
 */
public class Sindicalizado_Pessoais_DAO {
    ...
    Sindicalizado_Pessoais dp = new Sindicalizado_Pessoais();
    ...
    public ArrayList<Sindicalizado_Pessoais> pesquisar_restaurar(String nome) {
        con = Conexao_banco.conector();
    ...
    public ArrayList<Sindicalizado_Pessoais> listar_Tabela_Dados_Pessoais() {
        con = Conexao_banco.conector();
    ...
    public ArrayList<Sindicalizado_Pessoais> pesquisar_nome_cpf_rg(String nome, String cpf, String rg) {
        con = Conexao_banco.conector();
    ...
    public ArrayList<Sindicalizado_Pessoais> pesquisar_nome_cpf(String nome, String cpf) {
    ...
    public ArrayList<Sindicalizado_Pessoais> pesquisar_nome_rg(String nome, String rg) {
        con = Conexao_banco.conector();
    ...
    public ArrayList<Sindicalizado_Pessoais> pesquisar_nome(String nome) {
        con = Conexao_banco.conector();
    ...
    public ArrayList<Sindicalizado_Pessoais> pesquisar_cpf_rg(String cpf, String rg) {
        con = Conexao_banco.conector();
    ...
    public ArrayList<Sindicalizado_Pessoais> pesquisar_cpf(String cpf) {
        con = Conexao_banco.conector();
    ...
    public ArrayList<Sindicalizado_Pessoais> pesquisar_rg(String rg) {
        con = Conexao_banco.conector();
    ...
    public ArrayList<Sindicalizado_Pessoais> listar_Tabela_Dados_Pessoais_Restaurar() {
        con = Conexao_banco.conector();
    ...
    public ArrayList<Sindicalizado_Pessoais> listar_Tabela_Dados_Pessoais_Restaurar_NOME(String nome) {
        Restaurar_View re = new Restaurar_View();
        con = Conexao_banco.conector();
