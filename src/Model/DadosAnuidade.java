...
public class DadosAnuidade {
    ...
    /**
     * @return the pequenoProdutor_porcen
     */
    public int getPequenoProdutor_porcen() {
        return pequenoProdutor_porcen;
    }

    /**
     * @param pequenoProdutor_porcen the pequenoProdutor_porcen to set
     */
    public void setPequenoProdutor_porcen(int pequenoProdutor_porcen) {
        this.pequenoProdutor_porcen = pequenoProdutor_porcen;
    }
    ...
    /**
     * @return the medioProdutor_porcen
     */
    public int getMedioProdutor_porcen() {
        return medioProdutor_porcen;
    }

    /**
     * @param medioProdutor_porcen the medioProdutor_porcen to set
     */
     ...
     */
    public int getGrandeProdutor_porcen() {
        return grandeProdutor_porcen;
    }

    /**
     * @param grandeProdutor_porcen the grandeProdutor_porcen to set
     */
    public void setGrandeProdutor_porcen(int grandeProdutor_porcen) {
        this.grandeProdutor_porcen = grandeProdutor_porcen;
    }
